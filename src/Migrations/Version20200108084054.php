 ...
 */
final class Version20200108084054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movies CHANGE reviews reviews DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movies CHANGE reviews reviews DOUBLE PRECISION DEFAULT NULL');
